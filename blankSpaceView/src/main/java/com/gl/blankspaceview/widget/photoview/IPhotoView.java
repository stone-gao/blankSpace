...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewAttacker.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewAttacker.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewAttacker.OnViewTapListener listener);
     ...
     */
    void setOnScaleChangeListener(PhotoViewAttacker.OnScaleChangeListener onScaleChangeListener);
     ...
     */
    void setOnSingleFlingListener(PhotoViewAttacker.OnSingleFlingListener onSingleFlingListener);
}
